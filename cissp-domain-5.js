/* ============================================================
   CISSP Domain 5 — Layout 1 interactivity
   Attaches a hover / focus / tap tooltip (description + example)
   to any Access Control map box whose label has an entry in
   window.AC_DETAILS (cissp-domain-5-data.js). Reuses the shared
   .osi-tip tooltip styling from styles.css.
   ============================================================ */
(function () {
